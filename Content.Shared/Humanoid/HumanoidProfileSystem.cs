...
public sealed class HumanoidProfileSystem : EntitySystem
{
    ...
    /// <summary>
    /// Returns the entity's grammatical gender for voice/UI. Other systems must use this instead of reading
    /// <see cref="HumanoidProfileComponent.Gender"/> directly due to component access restrictions.
    /// </summary>
