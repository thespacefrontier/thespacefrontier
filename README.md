...
Оригинальный код **The Space Frontier** (`Content.Shared/_TSF/`, `Content.Server/_TSF/`, `Content.Client/_TSF/`) — по [GNU AGPLv3](LICENSE-AGPLv3.txt). Новые изменения в этих путях принимаются на условиях AGPLv3.
